...
namespace Graphics
{
    HoverButton CreateRoundedRectangleTextButton(HoverButton::callback_t callback, RectangleBounds rect_bounds, int corner_radius, std::shared_ptr<Font> font, std::string text, int font_size)
    {
        ...
        return HoverButton{callback, std::move(box_layout)};
    }

    HoverButton CreateHexagonTextButton(HoverButton::callback_t callback, Vector2 position, int hex_radius, std::shared_ptr<Font> font, std::string text, int font_size)
    {

...
#include "graphics/ui/TextButton.h"
...
void play_game()
{
    ...
    TextButton restart_button{[&hexasweeper_game, &tilemap, &game_region, comfortaa_font](){
        ...
        roboto_font, "Restart", 20
    };

    TextButton center_button{[&tilemap, &game_region](){
            tilemap->SetTopLeft(game_region.GetTopLeft());
        },
        {info_region.GetBottomLeft() + Vector2{12.5f, -85}, {100.0, 30.0}},
        roboto_font, "Center Camera", 13
    };

    // TODO: Pointers aren't cool.
    std::vector<TextButton*> active_buttons{&restart_button, &center_button};
